...
![image](https://github.com/user-attachments/assets/e85b0609-7922-4927-b633-4dd3aef93d37)
...
![image](https://github.com/user-attachments/assets/28ca4eb7-9628-403a-b390-ed9b00c169f1)
...
![image](https://github.com/user-attachments/assets/af2f3079-7d58-4afd-9f0a-b55c19b45aeb)
...
![image](https://github.com/user-attachments/assets/04ba46b8-e259-4827-9a1c-3834672d5829)
...
![image](https://github.com/user-attachments/assets/02a16520-20d5-4964-95b9-8b4200399482)
...
![image](https://github.com/user-attachments/assets/aee155db-81ad-46ff-b13c-30c1e86b01e2)
...
![image](https://github.com/user-attachments/assets/f10d99df-bc46-4da7-8789-ff88d92d4227)
...
![image](https://github.com/user-attachments/assets/6b1a826a-f930-4037-a077-d374101625af)
...
![image](https://github.com/user-attachments/assets/08d60ed5-95ff-4ebd-9f23-da169d07b954)


💡 네트워크 계층의 통신 단위는 데이터그램(datagram)이다.
데이터 그램을 한국어로 번역하자면 떠돌이 정도로 볼 수 있다.

- 3계층에서 만들어진 데이터그램과 헤더 중, 헤더에는 출발지 주소와 목적지 주소가 적혀있을 것
- 네트워크 상 데이터그램(패킷) 경로는 다익스트라 알고리즘과 같은 최단 경로 탐색 알고리즘으로 매번 변경될 수 있음
    - 이게 인터넷 발달의 근원이 되었다.

### 전송 계층 통신

![image](https://github.com/user-attachments/assets/a85192ca-18de-4f40-8eee-371713e4eff9)
...
패킷 : 3, 4계층 통신 단위를 패킷으로 퉁칠 때 부름
- 출발지 - 목적지가 있을 때 그 사이에 존재하는 라우터들이 전달하는 데이터는 3계층까지이고, 목적지에 가서야 비로소 4계층 데이터인 세그먼트를 볼 수 있다.

### 응용 계층 통신

![image](https://github.com/user-attachments/assets/28bec4bd-93a7-4d97-af68-0a07d459c83f)
...
> TCP/IP 프로토콜을 이용한 인터넷(internet)은 4개의 서로 다른 계층 주소가 사용된다.
> 
...
![image](https://github.com/user-attachments/assets/8dae453b-f62e-4a9f-80e9-6d1f39feeaf5)
...
![image](https://github.com/user-attachments/assets/2092d55a-4275-451b-be0d-ca025f50863f)
